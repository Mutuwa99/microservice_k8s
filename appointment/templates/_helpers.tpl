...
helm.sh/chart: {{ include "appointment.chart" . }}
...
*/}}
{{- define "appointment.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "appointment.fullname" .) .Values.serviceAccount.name }}
{{- else }}
